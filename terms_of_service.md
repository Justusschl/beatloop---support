...
Wichterichstraße 4
50937 Köln, Germany
Email: support@on-beat.de
Privacy Contact: privacy@on-beat.de
...
- Record video content synchronized with audio playback
- Create and share session metadata (markers, loops, segments)
...
### 4.5 BeatLoop's Role and Limitations
...
Send a written notice to support@on-beat.de including:
...
### 7.2 Subscription Terms and Payment

**iOS (Apple App Store):**
- Premium subscriptions on iOS are processed through Apple In-App Purchase
...
- Premium subscriptions on Android are processed through Google Play Billing
...
- Refunds are handled by Google according to their refund policy

**Web (if applicable):**
- Premium subscriptions on the web are processed through Stripe
- Billed according to your selected plan (monthly, yearly, etc.)
- Subscriptions automatically renew unless canceled at least 24 hours before the current period ends
- You may cancel your subscription at any time through your account settings

**Important:** BeatLoop does not collect or store payment card information via mobile apps. All payment processing on mobile is handled by Apple (iOS) or Google (Android).
...
### 8.1 BeatLoop's Intellectual Property
...
### 8.3 User Content License to BeatLoop
...
- Third-party music service availability is outside BeatLoop's control
...
- Contacting our support team at support@on-beat.de
- Ceasing to use the App (though your account will remain active)

### 12.2 Termination by BeatLoop
